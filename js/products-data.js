...
const PRODUCTS = [
  ...
  { id: 11,  name: "کشمیشی زەرد",              category: "raisins",   price: 7000, image: "images/products/raisins/کشمیشی-زەرد.png",       description: "کشمیشی زەرد دەرەجە یەک بۆ سەر برنچ و شیرنەمەنی",              bestSeller: false, featured: false },
  { id: 12,  name: "پونگی خۆمالی",              category: "raisins",   price: 6000, image: "images/products/raisins/پونگی-خۆمانی.png",       description: "پونگی خۆمالی بۆ شەربەت",              bestSeller: false, featured: false },

  // ================= تۆو / SEEDS ============================================
  { id: 13,  name: "تۆوی کودی زەرد",                   category: "seeds",     price: 8000,  image: "images/products/seeds/کودی-زەرد-برژاو.png",            description: "تۆوی کودی زەرد برژای بە خوێ", bestSeller: true,  featured: false },
  { id: 14, name: "تۆوی کودی زەردی خاو",                category: "seeds",     price: 8000, image: "images/products/seeds/کودی-زەرد-خاو.png",         description: "سرووشتی و پڕ لە پرۆتین بۆ دەرمان و نەخۆشی",                     bestSeller: false, featured: false },
  { id: 15, name: "تۆوی کودی سپی",                 category: "seeds",     price: 8000, image: "images/products/seeds/کودی-سپی-برژاو.png",          description: "کودی سپی برژاوی شەباح بە خوێ",           bestSeller: false, featured: false },
  { id: 16, name: "تۆوی کودی سپی خاو",                   category: "seeds",     price: 8000, image: "images/products/seeds/کودی-سپی-خاو.png",            description: "بۆ دەرمان و نەخۆشی پرۆستات",                     bestSeller: false, featured: true },
  { id: 17, name: "تۆوی کودی سوتای",                   category: "seeds",     price: 8000, image: "images/products/seeds/کودی-زەرد-سوتای.png",            description: "تۆوی کودی زەردی سوتای بە خوێ بە تام",                     bestSeller: false, featured: true },
  { id: 18, name: "ناوکە تۆوی کودی",                   category: "seeds",     price: 8000, image: "images/products/seeds/ناوکە-کودی.png",            description: "ناوکە کودی چوان و کەسک دەرەجە یەک",                     bestSeller: false, featured: true },
  { id: 19, name: "تۆوی مسری ",                   category: "seeds",     price: 6000, image: "images/products/seeds/تۆی-مسری-حامز.png",            description: "تۆوی مسری بە تامی لیمۆی ترش و بەتام",                     bestSeller: false, featured: true },
  { id: 20, name: "تۆوی شفتی",                   category: "seeds",     price: 10000, image: "images/products/seeds/تۆی-شفتی.png",            description: "تۆوی شفتی برژاو بە خوێ درشتی دەرەجە یەک",                     bestSeller: false, featured: true },
  { id: 21, name: "تۆوی گوڵە بەرۆژە",                   category: "seeds",     price: 5000, image: "images/products/seeds/تۆی-گوڵەبەرۆژە.png",            description: "تۆوی گوڵە بەرۆژەی درشت و بەتام",                     bestSeller: false, featured: true },

  // ================= سماق / SUMAC ==========================================
  { id: 22, name: "سماقی سۆری دنک",              category: "sumac",     price: 13000,  image: "images/products/sumacs/سماقی-سۆری-دنک.png",       description: "سماقی سۆری دنک ی ئاکرێ ترشو بەلە زەت",            bestSeller: false, featured: false },
  { id: 23, name: "سماقی سپی دنک",               category: "sumac",     price: 14000,  image: "images/products/sumacs/سماقی-سپی-دنک.png",        description: "سماقی سپی دنک ی ئاکرێ درشتو ترش",                 bestSeller: false, featured: false },
  { id: 24, name: "سماقی وردکراو",     category: "sumac",     price: 16000, image: "images/products/sumacs/سماقی-وردکراو.png",        description: "سماقی وردکراو ی ئاکرێ ساف سماق بێ خێو لیمدوزی",                    bestSeller: false, featured: false },

  // ================= چەرەسی تێکەلاو/ MIXED NUTS ============================
  { id: 25, name: "چەرەساتی دەرەجە یەک",         category: "mixed",     price: 18000, image: "images/products/mixeds/چەرەساتی-دەرەجە-یەک.png",        description: "چەرەساتی دەرەجە یەک پێک دێ لە سێ بابەت فستق گازۆ باوی",         bestSeller: true,  featured: true },
  { id: 26, name: "چەرەساتی دەرەجە دوو",      category: "mixed",     price: 14000, image: "images/products/mixeds/چەرەساتی-دەرەجە-دوو.png",     description: "چەرەساتی دەرەجە دوو پێک دێ لە پێنچ بابەت فستق و گازۆ و باوی و حەبیەد و تۆوی کودی سپی",            bestSeller: false, featured: false },

  // ================= کاجو / CASHEW ==========================================
  { id: 27, name: "گازۆی خاو",                 category: "cashew",    price: 18000, image: "images/products/cashews/گازۆی-خاو.png",          description: "گازۆی خاو ی ١٨٠ بەتام",                       bestSeller: true,  featured: false },
  { id: 28, name: "گازۆی برژاو",               category: "cashew",    price: 18000, image: "images/products/cashews/گازۆی-برژاو.png",        description: "گازۆی برژاوی ١٨٠ بە خوی برژاو نوێ",                   bestSeller: false, featured: true },

  // ================= بادام / ALMOND ========================================
  { id: 29, name: "بادامی خاو ئەمریکی",                 category: "almond",   price: 14000, image: "images/products/almonds/باوی-خاو-ئەمریکی.png",          description: "بادامی ئەمریکی خاو سروشتی و تازە",                       bestSeller: true,  featured: true },
  { id: 30, name: "بادامی برژاو",               category: "almond",   price: 14000, image: "images/products/almonds/باوی-برژاو.png",        description: "برژاوی تەواو، ترسکە و خۆش.",                  bestSeller: false, featured: false },
  { id: 31, name: "بادامی سپیکراو",             category: "almond",   price: 16000, image: "images/products/almonds/باوی-سپیکراو.png",      description: "بادەمی سپیکراو بۆ ناو خواردن",               bestSeller: false, featured: false },
  { id: 32, name: "بادەمی خاو خۆمالی",              category: "almond",   price: 20000, image: "images/products/almonds/باوی-خۆمالی-خاو.png",       description: "بادەمی خۆمالی بۆ نەخۆشی چەوری",                  bestSeller: false, featured: false },
  { id: 33, name: "بادەمی خاو ئیسپانی",              category: "almond",   price: 16000, image: "images/products/almonds/باوی-خاو-ئیسپانی.png",       description: "بادەمی ئیسپانی درشت و گەورە و بەتام",                  bestSeller: false, featured: false },
  { id: 34, name: "بادەمی بەپەلک",              category: "almond",   price: 4000, image: "images/products/almonds/باوی-بەپەلک.png",       description: "بادەمی بەپەلک ی خۆمالی سروشتی",                  bestSeller: false, featured: false },
